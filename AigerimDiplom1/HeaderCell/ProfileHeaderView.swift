...
class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    public lazy var nameLabel: CustomLabel = {
        let label = CustomLabel(text: "Алмазбекова Айгерим", Fontname: FontTextType.medium.rawValue, Fontsize: 18, UIColorhexRGB: ColorType.LabelTextColor.textBlackColor.rawValue, lineHeightMultiple: 1.24, kern: 0.16)
    ...
    public lazy var infoButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("Подробная информация", comment: ""), for: .normal)
    ...
    public lazy var editButton: CustomButton = {
        let button = CustomButton(title: NSLocalizedString("Редактировать", comment: ""),
    ...
    public lazy var messageButton: CustomButton = {
        let button = CustomButton(title: NSLocalizedString("Сообщение", comment: ""),
                                  fontname: FontTextType.bold.rawValue,
                                  fontsize: 16,
                                  backGroundColor: ColorType.LabelTextColor.textOrangeColor.rawValue,
                                  textColor: ColorType.LabelTextColor.textWhiteColor.rawValue,
    ...
    public lazy var subscriberButton: CustomButton = {
        let button = CustomButton(title: NSLocalizedString("Подписаться", comment: ""),
                                  fontname: FontTextType.bold.rawValue,
                                  fontsize: 16,
                                  backGroundColor: ColorType.LabelTextColor.textOrangeColor.rawValue,
                                  textColor: ColorType.LabelTextColor.textWhiteColor.rawValue,
