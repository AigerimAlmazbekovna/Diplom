//
//  MainHeaderViewViewController.swift
//  AigerimDiplom1
//
...
class MainHeaderView: UITableViewHeaderFooterView {
    ...
    public lazy var dateTitleLabel: CustomLabel = {
        let label = CustomLabel(text: NSLocalizedString("Посты подписчиков", comment: ""), Fontname: FontTextType.medium.rawValue, Fontsize: 14, UIColorhexRGB: ColorType.LabelTextColor.textDescriptionColor.rawValue, lineHeightMultiple: 1.18, kern: 0.14)
