...
class SearchNoteHeaderView: UITableViewHeaderFooterView {
    ...
    public lazy var titleLabel: CustomLabel = {
        let label = CustomLabel(text: NSLocalizedString("Мои записи", comment: ""), Fontname: FontTextType.bold.rawValue, Fontsize: 16, UIColorhexRGB: ColorType.LabelTextColor.textOrangeColor.rawValue, lineHeightMultiple: 1.24, kern: 0.16)
