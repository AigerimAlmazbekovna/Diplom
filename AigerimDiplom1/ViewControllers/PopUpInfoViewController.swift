...
class PopUpInfoViewController: UIViewController {
    ...
    public lazy var titleLabel: CustomLabel = {
        let label = CustomLabel(text: NSLocalizedString("Информация", comment: ""), Fontname: FontTextType.medium.rawValue, Fontsize: 21, UIColorhexRGB: ColorType.LabelTextColor.textBlackColor.rawValue, lineHeightMultiple: 1.24, kern: 0.16)
        label.textAlignment = .left
        return label
    }()
    public lazy var firstNameLabel: CustomLabel = {
        let label = CustomLabel(text: NSLocalizedString("Информация", comment: ""), Fontname: FontTextType.medium.rawValue, Fontsize: 18, UIColorhexRGB: ColorType.LabelTextColor.textBlackColor.rawValue, lineHeightMultiple: 1.24, kern: 0.16)
        label.textAlignment = .left
        return label
    }()
