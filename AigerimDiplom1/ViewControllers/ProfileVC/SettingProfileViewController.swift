...
class SettingProfileViewController: UIViewController {
    ...
    public lazy var titleLabel: CustomLabel = {
        let label = CustomLabel(text: NSLocalizedString("Меню", comment: ""), Fontname: FontTextType.medium.rawValue, Fontsize: 26, UIColorhexRGB: ColorType.LabelTextColor.textBlackColor.rawValue, lineHeightMultiple: 1.18, kern: -0.17)
