...
class PhotosDetailViewController: UIViewController {
    ...
    private func createAlertController(indexPath : IndexPath) {
        let alertController = UIAlertController(title: NSLocalizedString("Внимание", comment: ""), message: NSLocalizedString("точно удалить фотографию?", comment: ""), preferredStyle: .alert)
        ...
        let cancelAction = UIAlertAction(title: NSLocalizedString("Нет", comment: ""), style: .default)
