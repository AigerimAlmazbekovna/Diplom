...
extension ProfileViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        case 0:
            ...
            profileHeader.nameLabel.text = "\(user.firstName ?? NSLocalizedString("Имя", comment: "")) \( user.secondName ?? NSLocalizedString("Фамилия", comment: ""))"
            profileHeader.professionLabel.text = "\(user.profession ?? NSLocalizedString("Профессия", comment: ""))"
