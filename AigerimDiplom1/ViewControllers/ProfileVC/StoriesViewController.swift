...
class StoriesViewController: UIViewController {
    ...
    public lazy var nameLabel: CustomLabel = {
        let label = CustomLabel(text: "Aigerim_Almazbekovna", Fontname: FontTextType.medium.rawValue, Fontsize: 12, UIColorhexRGB: ColorType.LabelTextColor.textWhiteColor.rawValue, lineHeightMultiple: 1.24, kern: 0.16)
    ...
    public lazy var pushStoriesButton: CustomButton = {
        let button = CustomButton(title: NSLocalizedString("Поделиться", comment: ""), fontname: FontTextType.regular.rawValue, fontsize: 20, backGroundColor: ColorType.LabelTextColor.textOrangeColor.rawValue, textColor: ColorType.LabelTextColor.textWhiteColor.rawValue, cornerRadius: 5, lineHeightMultiple: 1.24, kern: 0.16)
